    ...
    <div className="items-center justify-center flex pt-8 text-white">
      <div className="items-center flex flex-col justify-center bg-zinc-900 w-[350px] md:w-[500px] h-[500px] rounded-xl">
        ...
        >
          ...
          <input
            className="p-3 rounded-lg text-white bg-zinc-700"
            type="text"
            placeholder="Enter your username..."
            onClick={(e) => setUsernmae(e.target.value)}
          />
          ...
          />
          <button
            className="p-2 mt-3 rounded-lg bg-lime-600 hover:bg-lime-800 text-black cursor-pointer"
            type="submit"
          >
            Register
          </button>
